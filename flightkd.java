...
public class flightkd extends HttpServlet
{
   ...
   try
    {
      ...
      Statement stmt=con.createStatement();
            String q1="select * from flight1 where fid='f1'";
       pw1.println(q1);
...
"\n" +
"<table><tr><td>\n" +
"                         <center><font color=\"brown\" font size=\"12\" style=\"font-family:Brush Script Std;\">flight book</font></center>\n" +
"                 </td></tr></table>\n" +
"             <form name=\"myForm\" action=\"flightbook\" method=\"post\" >\n" +
"                 <table>\n" +
"                 \n" +
                  " <tr>\n" +
...
"                         <td align=\"center\"><input type=\"text\" name=\"n3\" value="+x.getString(8)+"></td>\n" +
"                      </tr>\n" +
  "                  <td width=\"16%\">Deaprture:&nbsp;&nbsp;\n" +
"                <select name=\"n6\">\n" +
