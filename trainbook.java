...
public class trainbook extends HttpServlet
{
  ...
  String dt=req.getParameter("n6");
    ...
    String q1="insert into train2 values('"+uid+"','"+tid+"','"+pers+"','"+fare+"','"+chck+"','"+chcko+"','"+total+"')";
...
"          <tr>\n" +
"              <td>\n" +
"                train booked successfully do you want to book more ?\n" +
"              </td>\n" +
"              <td><a href=\"utrain.html\">yes</a></td>\n" +
