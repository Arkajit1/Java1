...
public class trainmod extends HttpServlet
{
   ...
   try
    {
      ...
      Statement stmt=con.createStatement();
            String q1="select * from train1 where tid='"+tid+"'";
...
"                 </td></tr></table>\n" +
"             <form name=\"myForm\" action=\"trainupdt\" method=\"post\" >\n" +
"                 <table>\n" +
"                 \n" +
"                     <tr>\n" +
...
"                         <td align=\"center\"><input type=\"text\" name=\"n13\" value="+x.getInt(6)+"></td>\n" +
"                      </tr>\n" +
"                      <tr>\n" +
"                         <td align=\"left\"> <font face=\"Book Antiqua\" size=\"4\" color=\"Green\"> Our Fare : </font> </td>\n" +
"                         <td align=\"center\"><input type=\"text\" name=\"n14\" value="+x.getInt(7)+"></td>\n" +
"                      </tr>\n" +
 "                 \n" +
"                     <tr>\n" +
"                         <td ><font face=\"Book Antiqua\" size=\"4\" color=\"Green\">Way :</font></td>\n" +
"                         <td align=\"center\" ><input type=\"text\" name=\"n1\" value="+x.getString(8)+"></td>\n" +
"                      </tr>   \n" +
"                 \n" +
"                     <tr>\n" +
"                         <td ><font face=\"Book Antiqua\" size=\"4\" color=\"Green\">Class :</font></td>\n" +
"                         <td align=\"center\" ><input type=\"text\" name=\"n1\" value="+x.getString(9)+"></td>\n" +
"                      </tr>   \n" +
"                       <tr>\n" +
