...
public class flightsearch extends HttpServlet
{
    public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException
    {
        ...
        String orgn=req.getParameter("t1");
        String dest=req.getParameter("t2");
    ...
    String q1="select * from flight1 where orgn='"+orgn+"' or dest='"+dest+"'";
    pw1.println(q1);
...
"            <tr>\n" +
 "              <td>"+x.getString(1)+"</td>\n" +
                  ...
                  "              <td>"+x.getString(3)+"</td>\n" +
                   "              <td>"+x.getString(4)+"</td>\n" +
                  "              <td>"+x.getString(5)+"</td>\n" +
                "                <td><a href=flightp?id="+x.getString(1)+">book</a></td>\n" +
