...
public class trainstatp extends HttpServlet
{
...
"          </tr></table>\n" +
            ...
            
    {
          ...
          pw1.println("<html>\n" +
"<body>\n" +
"    <form method=\"post\" action=traindelp>\n" +
"        <table>\n" +
"            <tr>\n" +
 "              <td>"+x.getString(1)+"</td>\n" +
                  "              <td>"+x.getString(2)+"</td>\n" +
...
"                <td><a href=traindelp?id="+x.getString(1)+">delete payment</a></td>\n" +
