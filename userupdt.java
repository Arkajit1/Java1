   ...
   try
    {
      ...
      Statement stmt=con.createStatement();
            String q1="update reg1 set pass1 ='"+pass+"',nm ='"+nm+"',mnm ='"+mnm+"',lnm ='"+lnm+"',addr='"+addr+"' ,city ='"+city+"',pin ='"+pin+"',sq1='"+sq+"',ans1 ='"+ans+"' where uid1='"+uid+"'";
...
"                <tr>\n" +
"                <td>Username </td>\n" +
"               <td><input type=\"text\" name=\"fname1\" value="+uid+"></td>\n" +
"            </tr>\n" +
"            <tr>\n" +
"                <td>Password </td>\n" +
"               <td><input type=\"password\" name=\"fname2\"  value="+pass+" onblur=\"blurred()\"></td>\n" +
"            </tr>\n" +
"            <tr>\n" +
"                <td>Name</td>\n" +
"               <td><input type=\"text\" name=\"fname3\" value="+nm+"></td>\n" +
"            </tr>\n" +
"            <tr>\n" +
"                <td>Middle Name </td>\n" +
"               <td><input type=\"text\" name=\"fname4\" value="+mnm+"></td>\n" +
"            </tr>\n" +
"            <tr>\n" +
"                <td>Last Name </td>\n" +
"               <td><input type=\"text\" name=\"fname5\" value="+lnm+"></td>\n" +
"            </tr>\n" +
"            \n" +
"             <tr>\n" +
"                <td>Address</td>\n" +
"               <td><input type=\"text\" name=\"fname10\" value="+addr+"></td>\n" +
"               \n" +
"            </tr>\n" +
"            <tr>\n" +
"                <td>City</td>\n" +
"               <td><input type=\"text\" name=\"fname11\" value="+city+"></td>\n" +
"               \n" +
"            </tr>\n" +
"            <tr>\n" +
"            <td>Pincode</td>\n" +
"               <td><input type=\"text\" name=\"fname12\" value="+pin+"></td>\n" +
"               </tr>\n" +
"               \n" +
"               \n" +
"               <tr>\n" +
"                   <td> SECURITY QUESTION :-&nbsp;&nbsp;<select name=\"fname14\" value="+sq+">\n" +
...
"               \n" +
"               <td>\n" +
"            your ans<input type=\"text\" name=\"fname15\" value="+ans+">\n" +
"            \n" +
"                   </td></tr>\n" +
"           \n" +
