   ...
   try
    {
      ...
      Statement stmt=con.createStatement();
            String q1="select * from reg1 where email='"+email+"'";
...
"\n" +
"\n" +
"<form method =\"post\" action=\"fpt\">\n" +
"<table>\n" +
"    <tr>\n" +
"        <td><font color=\"brown\" font size=\"5\" style=font-family:Trebuchet MS >what is your "+x.getString(12)+"?</font></td>\n" +
"        <td><input type=\"text\" name=\"fname15\">\n" +
"<td>\n" +
"    <table><tr><td><center><input type=\"submit\" value=\"submit\"></center></td></tr></table>\n" +
"</td>\n" +
"</tr>\n" +
"</table>\n" +
"</form>\n" +
