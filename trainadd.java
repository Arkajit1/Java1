...
public class trainadd extends HttpServlet
{
   ...
   try
    ...
    String q1="insert into train1 values('"+tid+"','"+orgn+"','"+dest+"','"+depf+"','"+arrf+"','"+actf+"','"+ourf+"','"+way+"','"+clss+"','"+pers+"')";
...
"          <tr>\n" +
"              <td>\n" +
"                  train added successfully do you want to add more ?\n" +
"              </td>\n" +
"              <td><a href=\"trainadd.html\">yes</a></td>\n" +
