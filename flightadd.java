...
public class flightadd extends HttpServlet
{
   ...
   try
    ...
    String q1="insert into flight1 values('"+fid+"','"+agncy+"','"+orgn+"','"+dest+"','"+depf+"','"+arrf+"','"+actf+"','"+ourf+"','"+way+"','"+clss+"',"+pers+")";
...
"          <tr>\n" +
"              <td>\n" +
"                  flight added successfully do you want to add more ?\n" +
"              </td>\n" +
"              <td><a href=\"flightadd.html\">yes</a></td>\n" +
