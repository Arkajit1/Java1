...
public class hotelupdt extends HttpServlet
{
   ...
   try
    {
      ...
      Statement stmt=con.createStatement();
            String q1="update hotel1 set agncy ='"+agncy+"',hrm="+hrm+",actf="+actf+", ourf="+ourf+" where hid='"+hid+"'";
...
"\n" +
"<table><tr><td>\n" +
"                         <center><font color=\"brown\" font size=\"12\" style=\"font-family:Brush Script Std;\">HOTEL UPDATED SUCCESSFULLY</font></center>\n" +
"                 </td></tr></table>\n" +
...
"                         <td align=\"center\" ><input type=\"text\" name=\"n1\" value="+hid+"></td>\n" +
"                      </tr>   \n" +
"                      <tr>\n" +
"                          <td ><font face=\"Book Antiqua\" size=\"4\" color=\"Green\">Agency: </font></td>\n" +
"                         <td align=\"center\"><input type=\"text\" name=\"n2\" value="+agncy+"></td>\n" +
"                      </tr>\n" +
                  "                      <tr>\n" +
"                          <td ><font face=\"Book Antiqua\" size=\"4\" color=\"Green\">Room: </font></td>\n" +
"                         <td align=\"center\"><input type=\"text\" name=\"n4\" value="+hrm+"></td>\n" +
"                      </tr>\n" +
"                     \n" +
"                      <tr>\n" +
