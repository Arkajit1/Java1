...
public class hotelgoa extends HttpServlet
{
   ...
   try
    {
      ...
      Statement stmt=con.createStatement();
            String q1="select * from hotel1 where hid='goa'";
       pw1.println(q1);
...
"            <font color=\"yellow\" font size=\"14\" style=\"font-family:Brush Script Std;\">LA FLAMINGO INTERNATIONAL  <img src=\"r.jpg\" width=\"30\" height=\"30\"> </font></marquee></td>\n" +
"</tr>\n" +
"</table>\n" +
"\n" +
"<table><tr><td>\n" +
...
"                         <td align=\"center\"><input type=\"text\" name=\"n3\" value="+x.getString(10)+" readonly ></td>\n" +
"                      </tr>\n" +
"                      <tr>\n" +
